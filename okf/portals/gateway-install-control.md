...
Surfaces et playbooks de provisioning, installation et contrôle gateway.
...
| Déploiement | Gateway locale + Ansible |
| Horizon | 2025/2026 lorsque sourcé par roadmap, sinon TBD par item |

# Dépôts

* [Essensys Raspberry Install](/systems/essensys-raspberry-install.md)
* [Essensys Raspberry Gateway](/systems/essensys-raspberry-gateway.md)
* [Essensys Ansible](/systems/essensys-ansible.md)

# Roadmap liée

* [Essensys Gateway Nixos](/roadmap/essensys-gateway-nixos.md)
* [Essensys Gateway Fleet 2026 06 019](/roadmap/essensys-gateway-fleet-2026-06.019.md)
* [Essensys Gateway Recovery 2026 06 018](/roadmap/essensys-gateway-recovery-2026-06.018.md)

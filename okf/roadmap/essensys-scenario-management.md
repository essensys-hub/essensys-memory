...
**Host repo:** [[ESSENSYS Memory]] **Path:** `essensys-memory/openspec/changes/essensys-scenario-management` **Status:** active **OpenSpec created:** 2026-06-20
...
| Horizon année | 2026 |
| Source | `wiki/roadmap/changes/essensys-scenario-management.md` |
...
[1] [Roadmap source](../../wiki/roadmap/changes/essensys-scenario-management.md)

...
**Host repo:** [[ESSENSYS Memory]] **Path:** `essensys-memory/openspec/changes/essensys-plugin-framework-2026-07-035` **Status:** active **OpenSpec created:** 2026-07-06
...
| Horizon année | 2026 |
| Source | `wiki/roadmap/changes/essensys-plugin-framework-2026-07-035.md` |
...
[1] [Roadmap source](../../wiki/roadmap/changes/essensys-plugin-framework-2026-07-035.md)

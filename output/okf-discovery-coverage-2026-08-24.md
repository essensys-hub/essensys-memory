...
- Repositories discovered: 43
- Repositories covered by OKF: 43
- OKF concept documents: 117
...
- covered: `essensys-bdm-programmer` — layer `system`, era `modern`
...
- covered: `essensys-plugin-example` — layer `system`, era `modern`
- covered: `essensys-plugin-framework` — layer `system`, era `modern`
- covered: `essensys-plugin-sungrow` — layer `system`, era `modern`

...
| **2026-06.005** | [[Essensys Cloud Sync Scheduler]] | essensys-memory | — | completed | — |
...
2. Les changes **001–007, 009–011** existaient avant la queue ; l'ID est dans `roadmap_id` du `.openspec.yaml`.

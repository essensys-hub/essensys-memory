...
- **2026-06-26** `2a56a6f` — build(deps): Bump aws-actions/configure-aws-credentials from 4 to 6 (dependabot[bot])
- **2026-06-26** `df1b4a2` — build(deps): Bump aquasecurity/trivy-action from 0.28.0 to 0.36.0 (dependabot[bot])
- **2026-06-26** `4939242` — feat: process Essensys feature lifecycle (Jira, Trivy, bootstrap) (rhinosys)
- **2026-06-26** `cfd812b` — first commit (rhinosys)
